...
const bullets = [
  "Works in any language, any format",
  "Informal work counts — shops, trades, gigs, family businesses",
  "One-time setup, always searchable",
...
export default function ForPeople() {
  ...
  return (
    <section ref={ref} id="for-people" className="py-24 px-6">
      <div className="container mx-auto max-w-5xl">
        <motion.h2 initial={{ opacity: 0, y: 20 }} animate={inView ? { opacity: 1, y: 0 } : {}} className="font-display text-4xl sm:text-5xl font-bold text-center mb-4">
          Your story is more than <span className="gradient-text">your resume.</span>
        </motion.h2>
        <motion.p initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ delay: 0.15 }} className="text-muted-foreground text-center font-body mb-12 max-w-xl mx-auto">
          Every experience matters. CONXA makes it all count.
        </motion.p>
